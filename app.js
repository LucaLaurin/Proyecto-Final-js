...
Weather.prototype.setUnit = function () {
  //Switch entre Celsius y Farhenheit
  var prevUnit = "C";
...
}; //Animacion usando CSS @keyframes


function animate(selector, keyFrameName, duration, delay = 0, timing = "ease", iteration = 1) {
  //jQuery selector; CSS keyframes name; duracion en ms; delay en ms;
  $(selector).css({
    "visibility": "hidden"
  });
  setTimeout(function () {
...
function loadTooltips() {
  //Buscar por elementos que tienen ""data-tooltips attributes"" en la pag web y los muestra
